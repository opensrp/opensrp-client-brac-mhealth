...
public class HnppNavigationModel implements org.smartregister.chw.core.model.NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        if (navigationOptions.size() == 0) {
            ...
            navigationOptions.add(new NavigationOption(R.drawable.ic_icon_settings, R.drawable.ic_icon_settings, R.string.menu_ss_info, CoreConstants.DrawerMenu.SS_INFO, -1));
