    ...
    private void viewInteraction() {
        ...
        saveButton.setOnClickListener(view -> {
            if(!childFollowUpJsonString.isEmpty() && childReferralJsonString!=null && isImmunizationTaken!=null && isGmpTaken){
                ...
                Toast.makeText(NewANCRegistrationActivity.this,"Please fill-up all data to submit",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        notReferredBt.setOnClickListener(view -> {
            ...
            referralCheckIm.setColorFilter(ContextCompat.getColor(NewANCRegistrationActivity.this, android.R.color.holo_orange_dark));
        ...
        noImmunizationBt.setOnClickListener(view -> {
            ...
            immunizationCheckIm.setColorFilter(ContextCompat.getColor(NewANCRegistrationActivity.this, android.R.color.holo_orange_dark));
            checkButtonEnableStatus();
        });
        ...
        immunizationLay.setOnClickListener(view -> {
            ChildVaccinationActivity.startChildVaccinationActivity(NewANCRegistrationActivity.this,bundle,commonPersonObjectClient,isOnlyVacc);
        });

        gmpLay.setOnClickListener(view -> {
            //if(!isGmpTaken){
                ChildGMPActivity.startGMPActivity(NewANCRegistrationActivity.this,bundle,commonPersonObjectClient);
           // }
        });
        ...
        HnppConstants.getGPSLocation(this, new OnPostDataWithGps() {
            ...
            public void onPost(double latitude, double longitude) {
                try {
                    ...
                    JSONObject jsonForm = FormUtils.getInstance(NewANCRegistrationActivity.this).getFormJson(HnppConstants.JSON_FORMS.REFERREL_FOLLOWUP);
                    ...
                    Intent intent;
                    intent = new Intent(NewANCRegistrationActivity.this, HnppAncJsonFormActivity.class);
                    intent.putExtra(org.smartregister.family.util.Constants.JSON_FORM_EXTRA.JSON, jsonForm.toString());
