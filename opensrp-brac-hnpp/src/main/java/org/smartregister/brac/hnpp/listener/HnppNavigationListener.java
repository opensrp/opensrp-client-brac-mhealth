...
public class HnppNavigationListener extends NavigationListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getTag() instanceof String) {
            ...
            if (CoreConstants.DrawerMenu.ANC.equals(tag)) {
                startRegisterActivityWithOutFinish(getActivity(CoreConstants.REGISTERED_ACTIVITIES.ANC_REGISTER_ACTIVITY));
            }
            else if (CoreConstants.DrawerMenu.ALL_MEMBER.equals(tag)) {
