...
import org.smartregister.unicef.mis.fragment.ReferralMemberRegisterFragment;
...
public class ReferralMemberRegisterActivity extends ChildRegisterActivity implements GuestMemberContract.View {
    ...
    protected BaseRegisterFragment getRegisterFragment() {
        return new ReferralMemberRegisterFragment();
    }
...
//
    ...
    public void startRegistration() {
        AddMemberSearchActivity.startMigrationFilterActivity(ReferralMemberRegisterActivity.this,false);
    ...
    private void startFormActivity(boolean isNeedToUpdateData){
        try{
            Intent intent = new Intent(ReferralMemberRegisterActivity.this, GuestAddMemberJsonFormActivity.class);
