...
public class GuestMemberIdRepository extends BaseRepository {
    private static final String TAG = GuestMemberIdRepository.class.getCanonicalName();
    private static final String HouseholdIds_SQL = "CREATE TABLE guest_ids(_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,village_id VARCHAR NOT NULL,openmrs_id VARCHAR NOT NULL,status VARCHAR NULL, used_by VARCHAR NULL,synced_by VARCHAR NULL,created_at DATETIME NULL,updated_at TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP )";
    private static final String HouseholdIds_TABLE_NAME = "guest_ids";
    ...
    public String getUnusedVillageId(){
        ...
        try{
            ...
            String rawQuery = "select village_id,\n" +
                    ...
                    "from guest_ids group by village_id";
