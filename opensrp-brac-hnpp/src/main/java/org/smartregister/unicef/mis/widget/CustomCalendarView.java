...
public final class CustomCalendarView extends LinearLayout {
    ...
    int MIN_DISTANCE_FOR_FLING = 15; // dips
    ...
    @Nullable
    private CustomCalendarView.OnMonthTitleClickListener onMonthTitleClickListener;

    @Nullable
    private CustomCalendarView.OnDateClickListener onDateClickListener;

    @Nullable
    private CustomCalendarView.OnDateLongClickListener onDateLongClickListener;

    @Nullable
    private CustomCalendarView.OnMonthChangeListener onMonthChangeListener;

    @Nullable
    private CustomCalendarView.OnMultipleDaySelectedListener onMultipleDaySelectedListener;
    ...
    private void initTouchVariables() {
        ...
        gestureDetector = new GestureDetectorCompat(getContext(), new CustomCalendarView.CalendarGestureDetector());
    ...
    private void takeStyles(AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MaterialCalendarView, 0, 0);
...
//        }
    ...
    private void drawAdapterView() {
        final List<Day> days = obtainDays();
    ...
    public  List<Day> obtainDays() {
        int year = CalendarUtils.getYear(calendar);
        int month = CalendarUtils.getMonth(calendar);
        int firstDayOfWeek = CalendarUtils.getFirstDayOfWeek(calendar);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            for (int j = 0; j < 7; j++) {
                ...
                if (helper.isWithinCurrentMonth(i, j)) {
                    ...
                    c.set(Calendar.MONTH, currentMonthIndex);
                    c.set(Calendar.DAY_OF_MONTH, n[j]);

                    int m = CalendarUtils.getMonth(c);
                    int y = CalendarUtils.getYear(c);

                    if (n[j] == c.get(Calendar.DAY_OF_MONTH) && CalendarUtils.isWeekend(c) && currentMonthIndex == 0) {
                        d.setDay(n[j])
                                .setMonth(m)
                                .setYear(y)
                                .setCurrentDay(false)
                    ...
                    } else if (n[j] == c.get(Calendar.DAY_OF_MONTH) && currentMonthIndex == 0) {
                        d.setDay(n[j])
                                .setMonth(m)
                                .setYear(y)
                                .setCurrentDay(true)
                    ...
                    } else if (CalendarUtils.isWeekend(c)) {
                        d.setDay(n[j])
                                .setMonth(m)
                                .setYear(y)
                                .setCurrentDay(false)
                    ...
                    c.add(Calendar.MONTH, currentMonthIndex);
                    c.set(Calendar.DAY_OF_MONTH, n[j]);

                    d.setDay(n[j])
                            .setMonth(CalendarUtils.getMonth(c))
                            .setYear(CalendarUtils.getYear(c))
                            .setCurrentDay(false)
    ...
    public void clearDayViewSelection(Date currentDate) {
        if (currentDate != null) {
            Calendar calendar = Calendar.getInstance(Locale.getDefault());
...
//        }
    ...
    public CustomCalendarView shouldAnimateOnEnter(boolean shouldAnimate) {
        shouldAnimateOnEnter(shouldAnimate, DEFAULT_ANIM_DURATION, DEFAULT_ANIM_INTERPOLATOR);
        return this;
    }

    public CustomCalendarView shouldAnimateOnEnter(boolean shouldAnimate, long duration) {
        shouldAnimateOnEnter(shouldAnimate, duration, DEFAULT_ANIM_INTERPOLATOR);
        return this;
    }

    public CustomCalendarView shouldAnimateOnEnter(boolean shouldAnimate, @NonNull Interpolator interpolator) {
        shouldAnimateOnEnter(shouldAnimate, DEFAULT_ANIM_DURATION, interpolator);
        return this;
    }

    public CustomCalendarView shouldAnimateOnEnter(boolean shouldAnimate, long duration, @NonNull Interpolator interpolator) {
        if (shouldAnimate) {
    ...
    public CustomCalendarView setOnMonthTitleClickListener(@Nullable CustomCalendarView.OnMonthTitleClickListener onMonthTitleClickListener) {
        this.onMonthTitleClickListener = onMonthTitleClickListener;
        invalidate();
        return this;
    }

    public CustomCalendarView setOnDateClickListener(@Nullable CustomCalendarView.OnDateClickListener onDateClickListener) {
        this.onDateClickListener = onDateClickListener;
        invalidate();
        return this;
    }

    public CustomCalendarView setOnDateLongClickListener(@Nullable CustomCalendarView.OnDateLongClickListener onDateLongClickListener) {
        this.onDateLongClickListener = onDateLongClickListener;
        invalidate();
        return this;
    }

    public CustomCalendarView setOnMonthChangeListener(@Nullable CustomCalendarView.OnMonthChangeListener onMonthChangeListener) {
        this.onMonthChangeListener = onMonthChangeListener;
        invalidate();
        return this;
    }

    public CustomCalendarView setOnMultipleDaySelectedListener(@Nullable CustomCalendarView.OnMultipleDaySelectedListener onMultipleDaySelectedListener) {
        this.onMultipleDaySelectedListener = onMultipleDaySelectedListener;
        invalidate();
        return this;
    }

    private CustomCalendarView setLastSelectedDay(Date lastSelectedDay) {
        this.lastSelectedDay = lastSelectedDay;
        invalidate();
        return this;
    }

    public CustomCalendarView setTypeface(Typeface typeface) {
        this.typeface = typeface;
        invalidate();
        return this;
    }

    public CustomCalendarView setIsOverflowDateVisible(boolean isOverflowDateVisible) {
        this.isOverflowDateVisible = isOverflowDateVisible;
        invalidate();
        return this;
    }

    public CustomCalendarView setFirstDayOfWeek(int firstDayOfWeek) {
    ...
    public CustomCalendarView setDisabledDayBackgroundColor(int disabledDayBackgroundColor) {
        this.disabledDayBackgroundColor = disabledDayBackgroundColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setDisabledDayTextColor(int disabledDayTextColor) {
        this.disabledDayTextColor = disabledDayTextColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setCalendarBackgroundColor(int calendarBackgroundColor) {
        this.calendarBackgroundColor = calendarBackgroundColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setSelectedDayBackgroundColor(int selectedDayBackgroundColor) {
        this.selectedDayBackgroundColor = selectedDayBackgroundColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setWeekBackgroundColor(int weekBackgroundColor) {
        this.weekBackgroundColor = weekBackgroundColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setTitleBackgroundColor(int titleBackgroundColor) {
        this.titleBackgroundColor = titleBackgroundColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setSelectedDayTextColor(int selectedDayTextColor) {
        this.selectedDayTextColor = selectedDayTextColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setTitleTextColor(int titleTextColor) {
        this.titleTextColor = titleTextColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setDayOfMonthTextColor(int dayOfMonthTextColor) {
        this.dayOfMonthTextColor = dayOfMonthTextColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setDayOfWeekTextColor(int dayOfWeekTextColor) {
        this.dayOfWeekTextColor = dayOfWeekTextColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setCurrentDayTextColor(int currentDayTextColor) {
        this.currentDayTextColor = currentDayTextColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setWeekendTextColor(int weekendTextColor) {
        this.weekendTextColor = weekendTextColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setWeekendDays(int weekendDays) {
        this.weekendDays = weekendDays;
        invalidate();
        return this;
    }

    public CustomCalendarView setButtonBackgroundColor(int buttonBackgroundColor) {
    ...
    public CustomCalendarView setBackButtonColor(@ColorRes int colorId) {
        this.headerView.setBackButtonColor(ContextCompat.getColor(getContext(), colorId));
        invalidate();
        return this;
    }

    public CustomCalendarView setNextButtonColor(@ColorRes int colorId) {
        this.headerView.setNextButtonColor(ContextCompat.getColor(getContext(), colorId));
        invalidate();
        return this;
    }

    public CustomCalendarView setCurrentDayBackgroundColor(int currentDayBackgroundColor) {
        this.currentDayBackgroundColor = currentDayBackgroundColor;
        invalidate();
        return this;
    }

    public CustomCalendarView setBackButtonDrawable(@DrawableRes int drawableId) {
        this.headerView.setBackButtonDrawable(drawableId);
        invalidate();
        return this;
    }

    public CustomCalendarView setNextButtonDrawable(@DrawableRes int drawableId) {
        this.headerView.setNextButtonDrawable(drawableId);
        invalidate();
        return this;
    }

    public CustomCalendarView setMultiSelectDayEnabled(boolean multiSelectDayEnabled) {
