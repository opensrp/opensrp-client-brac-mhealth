...
import org.smartregister.unicef.mis.activity.GlobalSearchDetailsActivity;
import org.smartregister.unicef.mis.job.HnppPncCloseJob;
import org.smartregister.unicef.mis.job.NotificationGeneratorJob;
import org.smartregister.unicef.mis.model.HnppFamilyRegisterFragmentModel;
import org.smartregister.unicef.mis.presenter.HnppFamilyRegisterFragmentPresenter;
import org.smartregister.unicef.mis.provider.HnppFamilyRegisterProvider;
    ...
    public void setTotalPatients() {
        if (headerTextDisplay != null) {
            headerTextDisplay.setText(
                    String.format(getString(R.string.clients_household), HnppConstants.getTotalCount(clientAdapter.getTotalcount())));
