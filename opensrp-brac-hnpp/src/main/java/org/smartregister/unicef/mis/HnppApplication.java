package org.smartregister.unicef.mis;
...
import org.smartregister.unicef.mis.activity.AdoMemberRegisterActivity;
import org.smartregister.unicef.mis.activity.AdultMemberRegisterActivity;
import org.smartregister.unicef.mis.activity.AdultRiskRegisterActivity;
import org.smartregister.unicef.mis.activity.GuestMemberActivity;
import org.smartregister.unicef.mis.activity.HNPPJsonFormActivity;
import org.smartregister.unicef.mis.activity.HNPPMemberJsonFormActivity;
import org.smartregister.unicef.mis.activity.HnppAllMemberRegisterActivity;
import org.smartregister.unicef.mis.activity.HnppAncRegisterActivity;
import org.smartregister.unicef.mis.activity.HnppAncRiskRegisterActivity;
import org.smartregister.unicef.mis.activity.HnppChildRiskRegisterActivity;
import org.smartregister.unicef.mis.activity.HnppElcoMemberRegisterActivity;
import org.smartregister.unicef.mis.activity.HnppElcoRiskRegisterActivity;
import org.smartregister.unicef.mis.activity.HnppPncRegisterActivity;
...
import org.smartregister.unicef.mis.repository.CampRepository;
import org.smartregister.unicef.mis.repository.GlobalLocationRepository;
import org.smartregister.unicef.mis.repository.HALocationRepository;
import org.smartregister.unicef.mis.repository.GuestMemberIdRepository;
...
import org.smartregister.unicef.mis.activity.ChildRegisterActivity;
...
import org.smartregister.unicef.mis.nativation.view.HnppNavigationMenu;
import org.smartregister.unicef.mis.job.HnppJobCreator;
import org.smartregister.unicef.mis.model.HnppNavigationModel;
...
//        registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.REFERRALS_REGISTER_ACTIVITY, ReferralRegisterActivity.class);
    ...
    public static OtherVaccineRepository getOtherVaccineRepository() {
        if ( otherVaccineRepository == null) {
            otherVaccineRepository = new OtherVaccineRepository(getInstance().getRepository());
        }
        return otherVaccineRepository;
    }
