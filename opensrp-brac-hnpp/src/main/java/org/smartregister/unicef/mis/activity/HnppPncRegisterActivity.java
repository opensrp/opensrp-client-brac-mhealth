...
import org.smartregister.unicef.mis.fragment.HnppPncRegisterFragment;
...
public class HnppPncRegisterActivity extends AncRegisterActivity {
    ...
    public static void startHnppPncRegisterActivity(Activity activity, String memberBaseEntityID) {
        Intent intent = new Intent(activity, org.smartregister.unicef.mis.activity.HnppPncRegisterActivity.class);
