package org.smartregister.unicef.mis.risky_patient.repository;
 ...
 */
public class PncFollowUpRepository extends BaseRepository {
    ...
    protected static final String ANC_FOLLOW_UP_TABLE = "pnc_follow_up";
    ...
    protected static final String NO_OF_PNC = "no_of_pnc";
    ...
    public PncFollowUpRepository(Repository repository) {
        super(repository);
    }
    ...
    public void add(AncFollowUpModel ancFollowUpModel) {
        ...
        contentValues.put(NO_OF_PNC, ancFollowUpModel.noOfAnc);
...
//                    "where (r.risk_type is null or r.risk_type = (select max(risk_type) from risk_list as rl where rl.base_entity_id = a.base_entity_id)) " +
    ...
    protected AncFollowUpModel readCursor(Cursor cursor) {
       String baseEntityId = cursor.getString(cursor.getColumnIndex(BASE_ENTITY_ID));
        ...
        int noOfAnc = cursor.getInt(cursor.getColumnIndex(NO_OF_PNC));
