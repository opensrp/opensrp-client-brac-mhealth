...
import org.smartregister.unicef.mis.interactor.HnppChildProfileInteractor;
...
public class HnppChildProfilePresenter implements CoreChildProfileContract.Presenter, CoreChildProfileContract.InteractorCallBack, FamilyProfileExtendedContract.PresenterCallBack  {
    ...
    public void refreshProfileTopSection(CommonPersonObjectClient client) {
        ...
        String motherNameTxt = view.get().getContext().getResources().getString(org.smartregister.chw.core.R.string.care_giver_initials,motherName);
        getView().setMotherName(motherNameTxt);
