package org.smartregister.unicef.mis.imci.interactor;

import static org.smartregister.unicef.mis.sync.FormParser.getFormNamesFromEventObject;
...
public class IMCIAssessmentInteractor implements MemberHistoryContract.Interactor,MemberHistoryContract.InteractorANC {

    private AppExecutors appExecutors;
    private HnppVisitLogRepository visitLogRepository;

    public IMCIAssessmentInteractor(AppExecutors appExecutors){
