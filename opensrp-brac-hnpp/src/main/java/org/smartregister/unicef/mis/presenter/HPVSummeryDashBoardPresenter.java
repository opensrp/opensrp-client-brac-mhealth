...
import org.smartregister.unicef.mis.interactor.HPVSummeryDashBoardInteractor;
...
public class HPVSummeryDashBoardPresenter implements DashBoardContract.Presenter,DashBoardContract.InteractorCallBack {

    private DashBoardContract.View view;
    private HPVSummeryDashBoardInteractor interactor;

    public HPVSummeryDashBoardPresenter(DashBoardContract.View view){
        this.view = view;
        interactor = new HPVSummeryDashBoardInteractor(new AppExecutors(),new HPVSummeryDashBoardModel(view.getContext()));
