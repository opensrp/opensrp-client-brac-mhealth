package org.smartregister.unicef.mis.task;
...
import org.smartregister.unicef.mis.dao.VisitDao;
...
public class UpdateElcoServiceTask extends AsyncTask<Void, Void, Void> {
    ...
    public UpdateElcoServiceTask(Context context, RegisterViewHolder viewHolder, String baseEntityId) {
    ...
    protected Void doInBackground(Void... params) {
            ...
            String[] returnValue = VisitDao.getVisitInfo(baseEntityId, HnppConstants.EVENT_TYPE.ELCO);
