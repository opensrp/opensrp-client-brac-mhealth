...
//            HnppJsonFormUtils.updateFormWithSSName(jsonForm, GeoLocationHelper.getInstance().getSsModels());
...
//
//            HnppJsonFormUtils.updateFormWithSSName(jsonForm, GeoLocationHelper.getInstance().getSsModels(),ssId);
//
