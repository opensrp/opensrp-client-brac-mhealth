 ...
 */
public class IMCIRepository extends BaseRepository {
    ...
    private static final String CREATE_ASSESSMENT_TABLE =
            "CREATE TABLE AssessmentLogic(RecordId  INTEGER PRIMARY KEY,  QuestionNo  TEXT,  QuestionAnswer  TEXT,  LogicOperator  TEXT,  IsSpecial  INTEGER,  AgeInDay  INTEGER,  ResultTypeId  INTEGER,  Indicator  INTEGER,  AssessmentTypeId  INTEGER,  SymptomsId  INTEGER)";
...
//            + LOCATION_TABLE + "_" + SS_NAME + "_ind ON " + LOCATION_TABLE + "(" + SS_NAME + ")";
    ...
    public IMCIRepository(Repository repository) {
        super(repository);
    }
    ...
    public static void createTable(SQLiteDatabase database) {
        database.execSQL(CREATE_ASSESSMENT_TABLE);
    }
