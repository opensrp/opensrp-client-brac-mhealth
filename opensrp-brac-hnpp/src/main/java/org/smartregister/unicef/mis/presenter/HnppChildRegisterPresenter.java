...
public class HnppChildRegisterPresenter implements CoreChildRegisterContract.Presenter, CoreChildRegisterContract.InteractorCallBack {
    public static final String TAG = HnppChildRegisterPresenter.class.getName();
    ...
    public HnppChildRegisterPresenter(CoreChildRegisterContract.View view, CoreChildRegisterContract.Model model) {
