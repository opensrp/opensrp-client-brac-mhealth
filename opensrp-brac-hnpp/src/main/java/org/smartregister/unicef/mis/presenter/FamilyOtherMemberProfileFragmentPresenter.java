...
public class FamilyOtherMemberProfileFragmentPresenter extends CoreFamilyOtherMemberProfileFragmentPresenter {
    public FamilyOtherMemberProfileFragmentPresenter(
            FamilyOtherMemberProfileFragmentContract.View view, FamilyOtherMemberProfileFragmentContract.Model model,
