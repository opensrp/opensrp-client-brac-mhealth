...
public class HnppChwRepository extends Repository {
    ...
    private void upgradeToVersion44(SQLiteDatabase db) {
        GeoLocationRepository.createTable(db);
    ...
    private void upgradeToVersion25(Context context, SQLiteDatabase db) {
        try {
            db.execSQL("CREATE TABLE ec_guest_member (id VARCHAR,_id VARCHAR,base_entity_id VARCHAR,block_name VARCHAR,village_name VARCHAR,village_id VARCHAR,unique_id VARCHAR,first_name VARCHAR,father_name VARCHAR,phone_number VARCHAR," +
    ...
    private void upgradeToVersion28(Context context, SQLiteDatabase db) {
        ...
        try {
            db.execSQL("ALTER TABLE ec_visit_log ADD COLUMN block_name VARCHAR;");
