...
public class FamilyChangeContractInteractor implements FamilyChangeContract.Interactor  {
    ...
    protected FamilyChangeContractInteractor.Flavor flavor;
    ...
    public void updateFamilyRelations(Context context, FamilyMember familyMember, String lastLocationId) throws Exception {
        ...
        Pair<List<Client>, List<Event>> clientEventPair = HnppJsonFormUtils.processFamilyUpdateRelations(HnppApplication, context, familyMember, lastLocationId);
    ...
    protected void setHnppApplication() {
        this.HnppApplication = HnppApplication.getInstance();
    }

    protected void setFlavour() {
        this.flavor = new HnppFamilyChangeContractInteractor();
    }
}
