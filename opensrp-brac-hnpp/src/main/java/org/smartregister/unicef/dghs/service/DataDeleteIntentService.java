...
//            JSONObject results = new JSONObject(test);
    ...
    private void deleteEvents(boolean byBaseEntityId,JSONArray validEvents) throws Exception{
        ...
        for (int i = 0; i < validEvents.length(); i++) {
            ...
            if(builderEvent.toString().isEmpty()){
                ...
                builderVisits.append(COLUMN_NAME+" = '"+formSubmissionId+"'");
                if(!byBaseEntityId){
                    String visitId = HnppDBUtils.getVisitIdByFormSubmissionId(formSubmissionId);
                    builderVisitLog.append(" visit_id = '"+visitId+"'");
                }else {
                    builderVisitLog.append(COLUMN_NAME+" = '"+formSubmissionId+"'");
                }

                builderTargetAchievment.append(COLUMN_NAME+" = '"+formSubmissionId+"'");
                builderStockAchievment.append(COLUMN_NAME+" = '"+formSubmissionId+"'");
            }else{
    ...
    private void deleteMember(JSONArray validMemberEvents) throws Exception{
        ...
        StringBuilder builderGuest = new StringBuilder();
        for (int i = 0; i < validMemberEvents.length(); i++) {
            ...
            if(builderClient.toString().isEmpty()){
                ...
                builderGuest.append(" base_entity_id = '"+memberClientString+"'");
            }else{
