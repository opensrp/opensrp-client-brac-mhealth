package org.smartregister.unicef.dghs.actionhelper;
...
public class VitaminaAction extends HomeVisitActionHelper {
    ...
    public VitaminaAction(Context context, String serviceIteration, Alert alert) {
...
*/
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            str_date = HnppJsonFormUtils.getValue(jsonObject, MessageFormat.format("vitamin_a{0}_date", serviceIteration));
