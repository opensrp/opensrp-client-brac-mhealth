...
public class MemberActivityRegisterProvider extends org.smartregister.family.provider.FamilyActivityRegisterProvider {
    public MemberActivityRegisterProvider(Context context, CommonRepository commonRepository, Set visibleColumns, View.OnClickListener onClickListener, View.OnClickListener paginationClickListener) {
    ...
    protected void populatePatientColumn(CommonPersonObjectClient pc, SmartRegisterClient client, final RegisterViewHolder viewHolder) {
        ...
        eventType = (eventType.equalsIgnoreCase(CoreConstants.EventType.CHILD_HOME_VISIT) ? context.getString(R.string.interpunct) + " " + context.getString(R.string.home_visit) : "");
