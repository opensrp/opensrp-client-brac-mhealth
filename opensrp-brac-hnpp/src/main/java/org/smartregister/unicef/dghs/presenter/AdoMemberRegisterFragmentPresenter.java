...
public class AdoMemberRegisterFragmentPresenter extends CoreChildRegisterFragmentPresenter {

    private HnppAllMemberRegisterFragmentModel model;

    public AdoMemberRegisterFragmentPresenter(CoreChildRegisterFragmentContract.View view, CoreChildRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    public String getMainCondition() {
        return String.format(" %s is null AND %s", CoreConstants.TABLE_NAME.FAMILY_MEMBER+"."+DBConstants.KEY.DATE_REMOVED, ChildDBConstants.AdoFilterWithTableName());
    }

    @Override
    public String getMainCondition(String tableName) {
        return String.format(" %s is null AND %s", tableName + "." + DBConstants.KEY.DATE_REMOVED, ChildDBConstants.AdoFilterWithTableName());
    }
    @Override
