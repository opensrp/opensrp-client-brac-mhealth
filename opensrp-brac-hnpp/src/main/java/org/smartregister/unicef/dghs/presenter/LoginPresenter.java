...
import org.smartregister.unicef.dghs.interactor.LoginInteractor;
...
public class LoginPresenter extends BaseLoginPresenter implements BaseLoginContract.Presenter {
    ...
    public void processViewCustomizations() {
        try {
            ...
            ViewConfiguration loginView = HnppApplication.getJsonSpecHelper().getConfigurableView(jsonString);
