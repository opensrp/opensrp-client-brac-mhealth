...
//        public static final String ANC_GENERAL_DISEASE = "ANC General Disease";
    ...
    public static final Map<String,String> vaccineNameMapping = ImmutableMap.<String,String> builder()
            ...
            .build();
    public static final Map<String,String> vaccineNameMappingEng = ImmutableMap.<String,String> builder()
            .put("bcg","BCG")
            .put("opv_0","OPV-0")
            .put("opv_1","OPV-1")
            .put("pcv_1","PCV-1")
...
//            .put( JSON_FORMS.PREGNANCY_HISTORY,"পূর্বের গর্ভের ইতিহাস")
            ...
            .put(EVENT_TYPE.CHILD_PROFILE_VISIT, "Member Survey")
            .put(EVENT_TYPE.MEMBER_PROFILE_VISIT, "Member Survey")
            ...
            .put(EVENT_TYPE.CHILD_FOLLOWUP,"Child Followup")
