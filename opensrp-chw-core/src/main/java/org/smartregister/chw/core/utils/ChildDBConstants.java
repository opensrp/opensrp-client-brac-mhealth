...
public class ChildDBConstants {
    ...
    public static String elcoFilterWithTableName(){
        String query = " ((( julianday('now') - julianday(ec_family_member.dob))/(365/12)) >" + 120 + ")";
        String query2 = " ((( julianday('now') - julianday(ec_family_member.dob))/(365/12)) <" + 600 + ")";
    ...
    public static String elcoFilter(){
        String query = " ((( julianday('now') - julianday(dob))/(365/12)) >" + 120 + ")";
        String query2 = " ((( julianday('now') - julianday(dob))/(365/12)) <" + 600 + ")";
